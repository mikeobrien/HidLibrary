...
namespace HidLibrary
{
	internal static class NativeMethods
	{
		static NativeMethods()
		{
			...
			//DEVPKEY_Device_BusReportedDeviceDesc.fmtid = new Guid(0xa45c254e, 0xdf1c, 0x4efd, 0x80, 0x20, 0x67, 0xd1, 0x46, 0xa8, 0x50, 0xe0);

			// DEVPKEY_DeviceInterface_FriendlyName
			//DEVPKEY_Device_BusReportedDeviceDesc.pid = 2;
			//DEVPKEY_Device_BusReportedDeviceDesc.fmtid = new Guid(0x026e516e, 0xb814, 0x414b, 0x83, 0xcd, 0x85, 0x6d, 0x6f, 0xef, 0x48, 0x22);

			// DEVPKEY_Device_DriverDesc
			//DEVPKEY_Device_BusReportedDeviceDesc.pid = 4;
			//DEVPKEY_Device_BusReportedDeviceDesc.fmtid = new Guid(0xa8b865dd, 0x2e3d, 0x4094, 0xad, 0x97, 0xe5, 0x93, 0xa7, 0xc, 0x75, 0xd6);
		}
		...
		[DllImport("setupapi.dll")]
		static internal extern bool SetupDiEnumDeviceInterfaces(IntPtr deviceInfoSet, int deviceInfoData, ref Guid interfaceClassGuid, int memberIndex, ref SP_DEVICE_INTERFACE_DATA deviceInterfaceData);
